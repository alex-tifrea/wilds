...
def main():
    ...
    parser.add_argument('--keep_only_best_model', default=False, type=parse_bool, const=True, nargs='?',
                        help='If true, algorithm.model contains the best model (possibly early-stopped) after a call to train.')
